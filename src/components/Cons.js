...
import {UPDATE_ACTIVE_CONS, UPDATE_CONS} from "../reducers/rootReducer";
...
const mapDispatchToProps  = (dispatch) => {
    return {
        updateActiveCons: (id) => {
            dispatch({type: UPDATE_ACTIVE_CONS, id: id})
        },
        updateCons: (id, value) => {
            dispatch({type: UPDATE_CONS, payload: {id: id, value: value}})
        }
    }
};
